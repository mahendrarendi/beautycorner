                        ...
                        <div class="menu_area text-right">
                            <nav id="nav-menu">
                                <ul id="nav">
                                    ...
                                    <li><a href="https://www.sociolla.com/"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;Keranjang</a></li>
                                    <li><a href="https://www.hipwee.com/tag/kecantikan/"><i class="bi bi-file-earmark" aria-hidden="true"></i>&nbsp;Artikel</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
